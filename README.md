...
**O and NNN are the net-lease anchor pair.** O is the scale play — 15,000+ properties, monthly since 1969, global. NNN is the discipline play — ~68% AFFO payout ratio (tightest in net-lease), 35+ consecutive increases, necessity-retail focus. Both are Dividend Aristocrats. DCA both together for a diversified net-lease income core.
