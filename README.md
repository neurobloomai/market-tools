...
**O is the anchor.** The original net-lease monthly dividend REIT. Widest tenant diversification in the group (80+ industries, 15,000+ properties, no single tenant >4%) — what STAG has in industrial focus, O has in breadth. Both pay monthly; O has been doing it since 1969.
...
**Rate environment read for all five:** Low rates → cap rates compress, REIT prices rise, yield spread over T-bills attractive. High rates → yield competes with risk-free alternatives, REIT prices get pressured until the spread reopens. STAG and EPR are the most rate-sensitive of the five (higher single-name and sector-specific risk); O is the most rate-resilient operationally (essential tenant base + long lease terms + 30yr dividend growth track record through multiple rate cycles); AMT is the most cycle-insensitive (carrier contracts don't change with the economy).
