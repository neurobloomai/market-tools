...
| **WPC** | Diversified global net-lease REIT — US + Europe (~35-40% European properties with CPI-linked escalators); industrial/warehouse majority; ~$13B market cap; ~6-7% yield; **dividend cut ~20% in 2023** when spinning off office (NLOP) — not a Dividend Aristocrat, but post-spin portfolio is cleaner | Rate-sensitive (both Fed and ECB cycles matter); European CPI escalators partially hedge inflation | Industrial/warehouse exposure = more economic cycle sensitivity than O/NNN; European diversification adds geographic resilience; post-office-spin portfolio cleaner and higher quality |
