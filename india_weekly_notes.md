...
### 4/4 Aligned — 30 names

**Universe (30):** AARTIIND, ABB, ASIANPAINT, AUROPHARMA, BAJAJ-AUTO, BAJFINANCE, BHARATFORG, CAMS, CHOLAFIN, CIPLA, COFORGE, DATAPATTNS, DIVISLAB, EICHERMOT, GRINDWELL, HAL, ICICIBANK, LALPATHLAB, LAURUSLABS, MANKIND, MARICO, MOTHERSON, NESTLEIND, PAGEIND, PARAS, PERSISTENT, SBIN, SIEMENS, SUNPHARMA, TITAN


### 3/4 Near-Aligned — 10 names

BALKRISIND, BRITANNIA, CONCOR, CUMMINSIND, DEEPAKNTR, KPIL, LT, NAVINFLUOR, POLYCAB, TORNTPOWER
...
| **DEEPAKNTR** | [U] | 3/4 | 2.6% | 1.6% | 0.7x | ↓ |
| **BEL** | [U] | 1/4 | 2.9% | 2.9% | 0.6x | ↓ |
| **LT** | [U] | 3/4 | 3.0% | 2.3% | 0.7x | ↓ |
| **HAL** | [U] | 4/4 | 3.2% | 2.6% | 0.7x | ↑ |
| **TATAPOWER** | [U] | 0/4 | 3.2% | 2.9% | 0.6x | ↓ |
| **ICICIBANK** | [U] | 4/4 | 3.5% | 3.5% | 1.0x | ↑ |
| **EICHERMOT** | [U] | 4/4 | 3.8% | 2.6% | 0.7x | ↑ |
| **DMART** | [U] | 0/4 | 4.1% | 2.9% | 0.7x | ↓ |
| **BAJFINANCE** | [U] | 4/4 | 4.2% | 4.2% | 1.1x | ↑ |
| **POWERGRID** | [U] | 2/4 | 4.5% | 3.3% | 0.7x | ↓ |
| **SBIN** | [U] | 4/4 | 4.5% | 0.0% | 1.0x | ↑ |
| **CIPLA** | [U] | 4/4 | 4.6% | 4.6% | 1.5x | ↑ |
| **CHOLAFIN** | [U] | 4/4 | 4.9% | 4.9% | 0.8x | ↑ |
| **CONCOR** | [U] | 3/4 | 4.9% | 1.3% | 0.5x | ↓ |
...
| **ASTRAL** | — | — | ETF | — | Astral Ltd — pipes/adhesives/bathing compounder; OM ~13%, ROE ~18%, lo… |
...
| **IXIGO** | — | — | ETF | — | ixigo — travel-tech, recently listed, margins building |
| **KAYNES** | — | — | ETF | — | Kaynes Technology — defense/semi electronics, OM 11% but FCF -10% (hea… |
| **KFINTECH** | — | — | ETF | — | KFin Technologies — second MF registrar after CAMS (~30% market share)… |
| **M&M** | — | — | ETF | — | Mahindra & Mahindra — farm equipment + SUV (Scorpio/XUV) + EV; OM 16.4… |
| **MARUTI** | — | — | ETF | — | Maruti Suzuki — 50% India car market share, Suzuki tech, largest deale… |
