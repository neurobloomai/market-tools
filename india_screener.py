...
WATCHLIST = [
    ...
    '500147.BO',      # John Cockerill India (fmr CMI FPE) — two businesses: (1) steel processing lines (continuous annealing, galvanizing, processing equipment for JSW/Tata/ArcelorMittal — large project-based, sticky repeat customer relationships); (2) green hydrogen electrolysers (Belgian parent John Cockerill = top-5 electrolyser manufacturer globally; India subsidiary positioned to manufacture domestically for India's National Hydrogen Mission); Ramesh Damani accumulated stake — buying electrolyser optionality inside a profitable steel equipment business; BSE code 500147, yfinance fundamentals absent (BSE filings = real data source); P/E 87x (growth expectations priced in); project-based revenue = lumpy NM/FCF; thin float, small cap ₹2,881Cr; gate: OM/ROE/FCF confirming quality via BSE filings + green hydrogen order inflows visible; added 2026-08-12
