...
FUTURE_RADAR = {
    'SRE':  'Sempra — regulated California utilities (SoCalGas + SDG&E) + Sempra Infrastructure LNG; the LNG thesis is the reason to watch: Port Arthur LNG Phase 1 (Texas, 13.5 MTPA) under construction with take-or-pay offtake contracts signed + Energía Costa Azul LNG (Baja Mexico, Pacific-facing terminal = premium Asian buyers); take-or-pay = toll road cash flows once terminals are operational — the FCF drought is the build, not the business; 3/7 gates now: OM 28.3% + NM 16.8% + GrossM 44.0% pass; blockers = D/EV 0.359 (LNG capex debt, structural during build), FCF -50.4% (capex cycle, should reverse on terminal commissioning), ROE 6.7% + RevG -0.1% (regulated utility base drag); chart broken: 1/4 MA, RSI 39.3 bearish, price $83.88 below all MAs — market not yet pricing LNG commissioning optionality; gate to watchlist: Port Arthur LNG Phase 1 online + FCF turning positive + D/EV deleveraging below 0.25 + ROE recovering above 10%; realistically 2-3 years on LNG timeline; added FUTURE_RADAR 2026-08-09',
