...
WATCHLIST = [
    ...
    'HON',    # Honeywell International — diversified industrial conglomerate (Aerospace Technologies avionics/engines, Building Automation controls/fire/security, Energy & Sustainability Solutions process tech/UOP, Industrial Automation); currently splitting into three independent companies — Advanced Materials already spun off as Solstice (SOLS, added to this universe 2026-09-10) with Aerospace to follow; GrossM 36.5% ✓, OM 20.2% ✓, NM 21.6% ✓, ROE 46.6% ✓ (buyback-amplified), FCF 4.1% ✓, RevG 4.3% ✓ (modest) — 6/7 gates; D/EV 0.384 sole blocker, elevated partly by pre-breakup capital structure; grade A+; $64.4B market cap; -11.5% vs 200d MA (breakup uncertainty priced in); gate to UNIVERSE: D/EV trending down as the three-way separation completes and standalone leverage normalizes; added WATCHLIST 2026-09-10
    ...
    'LITE',   # Lumentum — photonics/optical components (datacenter transceivers + 3D sensing + telecom); AI datacenter interconnect tailwind, RevG 109.3% (up from 90.1% previously documented, real accelerating growth) and OM 28.0% (up from 21.8%) and D/EV 0.02 (down from 0.056) — the operating business is genuinely stronger than when this was last written, not weaker; but NM has collapsed to -230.1% and ROE to -240.0%, while ROA stays a sane +5.8% and trailing P/E stays positive/normal (28.1x) — that combination (deeply negative NM/ROE, sane ROA/PE) is the signature of a large one-time GAAP charge (impairment, restructuring, litigation — exact cause not confirmed, don't guess further than the pattern) hitting trailing net income once, not organic collapse; moved from UNIVERSE 2026-09-12 — was sitting there on a stale comment ("A+", no mention of the NM/ROE swing) that no longer matched live data, same pattern as the BMRN correction on 2026-09-11; grade A (mechanical, but genuinely uncertain given the charge is unconfirmed); gate back to UNIVERSE: NM/ROE recovering as the one-time item rolls out of the TTM window — watch the next 1-2 quarters rather than assume either direction
    ...
    'TKR',    # The Timken Company — engineered bearings + industrial motion products, two segments: Engineered Bearings (tapered/spherical/cylindrical roller bearings) + Industrial Motion (power transmission components); D/EV 0.219 hairline blocker (0.019 above the 0.20 gate) + ROE/ROA hairline blocker (ROE 8.5% vs 10% gate, 1.5pts short; ROA 5.4% vs 15% fallback) — 2/7 gates; grade B; sanity-checked for the margin-artifact pattern: not present, no impossible or sign-flipped margins, but worth naming honestly — MRQ is genuinely WEAKER than TTM here (opposite of NGVT above), OpM 3.0% MRQ vs 6.0% TTM, NM 2.3% MRQ vs 5.4% TTM, epsChangePercentTTM -17.6% — a real within-year softening, not a recovering business; trailing PE 31.6x vs fwdPE 16.0x — the market/analysts are pricing in a recovery from this soft patch, informational only, not our own differentiated view; not currently on the dividend list either (checked, absent from all three: UNIVERSE, WATCHLIST, dividend_plays_for_longterm.py); $8.1B market cap; gate to UNIVERSE: D/EV ≤ 0.20 + ROE crossing 10% as the softening reverses; added WATCHLIST 2026-09-15
]
