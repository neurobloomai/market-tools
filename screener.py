...
WATCHLIST = [
    ...
    'DOCS',   # Doximity — physician network + pharma marketing platform + health system SaaS (telehealth, clinical workflow tools for 80%+ of US physicians); GrossM 88.07% (purest network economics in healthcare — physicians can't leave, pharma needs to reach them, platform is the toll); FCF 36.56%, D/EV 0.0023 (effectively zero debt), OM 21.54%, ROE 17.21%, RevG 7.30% (already in UNIVERSE on fundamentals); full technical: MA 25/25 ✓, Slope 15/15 ✓, RSI 15/15 ✓, Smoothness 10/10 ✓ — four pillars firing; CMF 0/25 ✗ (institutions not confirming yet — this is the gate, not a blocker forever), Runway 1/10 ✗ (near ceiling, needs consolidation before extension); sizing weight 0.191 at CMF=0; gate: CMF crossing +0.10 (institutional accumulation confirming the MA+slope+smoothness signal) + runway rebuilding via 2-4 week consolidation — when both fire, technical score jumps ~15-25 pts; also in UNIVERSE (fundamentals qualify already); added WATCHLIST 2026-09-02
]
