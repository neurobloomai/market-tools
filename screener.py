...
WATCHLIST = [
    ...
    'HIG',   # Hartford Financial Services — P&C + Group Benefits (life/disability insurance) + Mutual Funds; ROE 22.1%, FCF 13.8%, OM 17.6%, NM 14.9%, D/EV 0.109, PE 10.1x — passes all quality filters; business is solid but forward earnings trajectory not converging with TRV/ALL over the next 2-3 years (TRV and ALL repricing tailwind stronger); grade A on current metrics; gate: earnings growth reaccelerating to match TRV/ALL trajectory; added 2026-07-30
