...
WATCHLIST = [
    ...
    'ADBE',  # Adobe — creative cloud monopoly (Photoshop/Illustrator/Acrobat); OM 35.3%, NM 28.7%, GrossM 89.4%, ROE 63%, FCF $9.2B, fwd P/E 8x; D/E 0.61 only blocker (Figma deal debt, FCF clears it in ~1yr); 0/4 MA — chart broken on AI disruption fear; wait for weekly MA structure to recover
