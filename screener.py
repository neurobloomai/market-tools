...
WATCHLIST = [
    ...
    'MKSI',                    # MKS Instruments — process control subsystems inside semiconductor fab tools (AMAT/Lam/KLA); pressure, flow, power, gas management + Newport photonics/lasers; design-in moat real (re-qualification cost locks in MKS components once qualified); GrossM 46.7%, OM 14.4%, NM 7.5%, ROE 10.8%, D/EV 0.183, FCF 12.6%, RevG 28.3% — all 7 gates pass on current numbers; watchlist over UNIVERSE: (1) high cyclicality with semicon capex — metrics deteriorate sharply in downturns; (2) $4.45B Atotech acquisition debt (PCB chemicals — less defensible than instruments); (3) D/EV 0.183 too close to gate for comfort; gate to UNIVERSE: D/EV ≤ 0.15 as Atotech debt pays down + NM solidly above 10% through a full semicon cycle; moved to WATCHLIST 2026-08-07; auto-promoted 2026-08-07 [grade B, 2/4 MA]; corrected 2026-09-10 — was still physically sitting in UNIVERSE despite this comment saying otherwise since 2026-08-07
