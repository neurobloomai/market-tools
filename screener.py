...
UNIVERSE = [
    ...
    'MKSI',                       # MKS Instruments — process control subsystems inside semiconductor fab tools (AMAT/Lam/KLA); pressure, flow, power, gas management + Newport photonics/lasers; design-in moat: once MKS components are process-qualified at a fab, swapping them requires full re-qualification — not done lightly; GrossM 46.7%, OM 14.4%, NM 7.5%, ROE 10.8%, D/EV 0.183, FCF 12.6%, RevG 28.3%; passes all 7 gates (A); durability caveats: (1) highly cyclical with semiconductor capex — revenue drops hard in downturns; (2) $4.45B debt from 2022 Atotech acquisition (PCB chemicals — less defensible than instruments side); (3) D/EV 0.183 close to 0.20 gate — watch in semicon downturns; fwdPE 17.8x; grade A; added 2026-08-07
    'CRM','NOW','FTNT','PANW',
