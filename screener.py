...
WATCHLIST = [
    ...
    'ACAD',  # Acadia Pharmaceuticals — CNS/rare disease; Nuplazid (only FDA-approved Parkinson's psychosis drug) + DAYBUE (Rett syndrome, 2023); NM 34.3%, ROE 37.3%, D/E 0.041, FCF $154M; OM -1.7% only blocker; 2026 earnings outlook bleak — future consideration, not actionable now
