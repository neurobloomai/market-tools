...
UNIVERSE = [
    ...
    'B',                          # Barrick Mining (formerly Barrick Gold) — world's #2 gold miner + major copper producer (Nevada/Pueblo Viejo/Lumwana mines); rebranded + ticker changed GOLD→B 2025; low-cost operator, D/EV ~0.08, meaningful gold+copper leverage; A
