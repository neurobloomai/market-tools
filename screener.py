...
WATCHLIST = [
    ...
    'GOLD',  # Barrick Gold (NYSE, Canadian HQ, USD-reported) — world's 2nd largest gold miner; gold + copper production; AI/datacenter infra = structural USD demand = gold tailwind; 1H MA setup firing 2026-07-01 ($43, 1.4% above MA10); daily still below MA10 ($42.03) — wait for daily confirmation; NOTE: yfinance .info returns wrong company for GOLD — chart-only tracking, quality filters not applicable
