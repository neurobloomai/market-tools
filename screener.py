...
WATCHLIST = [
    ...
    'SOFI',    # SoFi Technologies — neobank with bank charter (granted Jan 2022, transformative: hold deposits and fund loans at much lower cost than warehouse lines, no longer dependent on external funding); auto-promoted from FUTURE_RADAR 2026-08-11 [grade A, blocking: ROE/ROA ROE 7.1% / ROA 1.2%, FCF Yield missing (no data relief)]
    'LYFT',    # Lyft — US-only ride-sharing (Uber competitor, ~28% US market share); auto-promoted from FUTURE_RADAR 2026-08-11 [grade A, blocking: Op Margin 2.6%]
]
