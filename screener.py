...
UNIVERSE = [
    ...
    'ROL','CTAS','CPRT','ADP','PAYX','EFX','TRI','VRSK','IT',
...
WATCHLIST = [
    ...
    'RELY',    # Remitly — digital cross-border remittances; immigrant-to-family corridor, mobile-first; GrossM 60.8%, OM 14.4%, NM 6.1%, ROE 13.0%, D/EV 0.009 (net cash), FCF 3.5%, RevG 25.2%; 7/7 gates pass, grade A; 4/4 MA aligned, slope +2.5%, MACD expanding — clean setup; gate: OM ≥ 20% + NM ≥ 10% as scale drives operating leverage; added 2026-08-06
]
