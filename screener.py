...
WATCHLIST = [
    ...
    'TGTX',  # TG Therapeutics — Briumvi (ublituximab, anti-CD20 MS); faster infusion than Ocrevus, scaling fast; NM 66%, OM 17%, GrossM 83%, ROE 112%, RevG 69.6%, fwd P/E 18.6x; D/E 1.29 (commercialization converts) + FCF -$30M (near-zero, turns positive as revenue compounds) blocking; 4/4 MA aligned, price at MA10d — entry here
