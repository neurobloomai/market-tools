...
UNIVERSE = [
    ...
    'MU',
    'SNDK',  # SanDisk — pure-play NAND flash spun out of Western Digital (Feb 2025); manufactures enterprise + consumer SSDs via 50/50 JV with Kioxia (BiCS NAND technology — one of only 3 fully integrated NAND stacks globally alongside Samsung and Micron); A+ grade confirmed; 87w STRUCT blank — insufficient weekly history as new spinoff, framework loses long-term structural lens; spin-off gives cleaner financials vs WDC (no HDD drag); NAND more commoditized than DRAM — pricing cycles can be violent; QQQ constituent; -25.6% from 52w hi, barely below 10w MA (-1.0%), CMF +0.195 (accumulating); slope -5.8% (declining); added UNIVERSE 2026-08-19
