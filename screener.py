...
FUTURE_RADAR = {
    ...
    'EMBC': 'Embecta — BD spinoff (2022), insulin delivery devices (pen needles, syringes, patch pumps); franchise: every insulin-dependent diabetic needs delivery devices = repeat purchase, low switching cost for BD, stable volumes historically; GrossM 61.9%, OM 19.3%, NM 10.7%, FCF 70.7%; D/EV 0.984 (BD loaded spinoff with debt), ROE 0%, RevG -14.4% declining; structural headwind: GLP-1 drugs (Ozempic/Wegovy/Mounjaro) reducing insulin dependence in Type 2 diabetics = long-term volume compression for injection delivery devices; Type 1 diabetics (insulin-dependent regardless) are the floor, but Type 2 volume is the growth driver being eroded; price $4.67, -57% below 87w MA — market pricing GLP-1 secular displacement; gate to watchlist: D/EV below 0.40 (debt paydown from FCF) + RevG stabilizing as GLP-1 displacement plateaus at Type 1 floor + OM sustained above 15%; added FUTURE_RADAR 2026-08-07',
