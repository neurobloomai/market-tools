...
WATCHLIST = [
    ...
    'TPL',     # Texas Pacific Land — largest private landowner in Permian Basin (~880K acres); royalty + water services model: collects royalties on every barrel produced on its land without drilling risk; GrossM 93.2%, OM 77.2%, NM 60.0%, ROE 36.5%, ROA 25.2%, D/EV 0.001 (zero debt), RevG 20.8% — A+ on every metric; FCF -0.2% only blocker (almost certainly yfinance artifact — royalty businesses don't structurally burn cash at 60% NM; gate: FCF confirmed positive next quarter); added WATCHLIST 2026-07-29
    'MOD',     # Modine Manufacturing — AI datacenter thermal/cooling (heat exchangers); auto-promoted from FUTURE_RADAR 2026-07-29 [grade B, blocking: Net Margin 3.8%, FCF Yield -1.0%]
    'ACAD',    # Acadia Pharmaceuticals — CNS/rare disease; auto-promoted from FUTURE_RADAR 2026-07-29 [grade B, blocking: Op Margin -1.7%]
    ...
    'PGY',     # Pagaya Technologies — AI-powered credit underwriting network; auto-promoted from FUTURE_RADAR 2026-07-29 [grade B, blocking: Debt/EV 0.81]
]
