...
UNIVERSE = [
    ...
    'ABNB',                       # Airbnb — asset-light home-sharing marketplace; NM 19.9%, ROE 32%, D/EV 0.037, FCF solid; yfinance OM distorted by SBC/charges (true OM ~12-13%), quality real
                                  # ANET demoted to watchlist 2026-07-17 — weekly slope turned negative (gate closed), valuation extension; monthly structure intact, fundamentals A+ unchanged; gate back: weekly slope positive + MA10w > MA20w sustained
...
WATCHLIST = [
    ...
    'ANET',  # Arista Networks — AI datacenter networking (not cyber); 42.7% OM, 38.3% NM, ROE 31.5%, zero debt, A+ quality unchanged; demoted 2026-07-17: weekly slope turned negative, daily -EXT, valuation extended after strong run; monthly structure intact + fundamentals undisturbed = watchlist not exit; gate back to universe: weekly gate reopens (MA10w > MA20w + slope positive sustained)
