...
FUTURE_RADAR = {
    ...
    'SOFI': 'SoFi Technologies — neobank with bank charter (granted Jan 2022, transformative: hold deposits and fund loans at much lower cost than warehouse lines, no longer dependent on external funding); started as student loan refinancer, expanded into personal loans, credit cards, checking/savings, investing, and home loans; B2B flywheel: Galileo (API fintech infrastructure powering 140M+ accounts — Robinhood, Chime, Dave run on Galileo) + Technisys (cloud-native banking core, acquired 2022) = retail bank + fintech infrastructure toll; GrossM 83.7% (exceptional — software-influenced economics on a bank), OM 17.0% ✓, NM 14.9% ✓ (computed manually — yfinance artifact from banking leverage), RevG 42.6% ✓ (exceptional growth, bank charter enabling), D/EV 0.146 ✓ (clean fintech structure); blocker: ROE 7.1% — NI growing fast but equity base still building from pre-profitability era losses (needs 2-3 more quarters of retained earnings compounding into equity); FCF near 0% — reinvesting heavily in member acquisition; price $18.03 below $20 floor; gate: price crossing $20 + ROE crossing 10% as retained earnings compound into equity base + FCF turning measurably positive; re-evaluate when both gates clear',
    'LYFT': 'Lyft — US-only ride-sharing (Uber competitor, ~28% US market share); restructured 2023 to focus purely on core US rideshare (sold bikes/scooters + Canadian ops) — cleaner business model; FCF 17.0% ($1.15B on $6.77B revenue) is the honest signal and exceptional for a marketplace that owns no cars; RevG 16.1% ✓; GrossM 38.0% (just below 40% gate — marketplace take-rate economics, structural ceiling from driver incentive costs), OM 2.58% (below 10% gate — insurance normalization + tech investment), D/EV 0.214 (just above 0.20 gate — convertible notes); NM 42.3% is a one-time legal settlement gain, not operational; ROE 152.6% is negative-equity artifact from accumulated losses — ignore both; price $17.62 below $20 floor; moat question: Uber has 72% US share and international diversification — Lyft is the structurally weaker competitor with no exit from the US market; the FCF is real and the restructuring is real, but the competitive position is permanently disadvantaged; gate: price crossing $20 + OM crossing 10% as insurance costs normalize and driver supply stabilizes + GrossM crossing 40% + clear path to D/EV ≤ 0.20 via converts retiring',
