...
WATCHLIST = [
    ...
    'IBOC',  # International Bancshares — Texas-based regional bank (US-Mexico border corridor); OM 63.9%, NM 49.9%, ROE 13.5%, D/EV 0.151, RevG 5.4% — 5/7 gates; FCF 0.0% + GrossM 0.0% are banking yfinance artifacts (same as RJF/PNC — banks don't report GrossM, FCF is not standard); well-run regional franchise with strong NIM discipline in the border region; RevG 5.4% slow — regional bank not a compounder; gate: yfinance data confirming FCF + RevG re-accelerating as rate cycle turns; added WATCHLIST 2026-08-07
