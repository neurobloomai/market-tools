...
**Universe (58):** AAPL, ABBV, ABNB, ACGL, AFL, ALGN, ANET, AON, ASML, ATEN, BLK, BMRN, CASH, CB, CF, CHD, CHRW, CINF, CL, CRWD, CTAS, DDOG, DXCM, EXPD, FFIV, FTNT, HEI, HWM, IBKR, INCY, ITW, JBHT, JNJ, JPM, KRYS, LLY, MA, MCO, META, MNST, MRK, MSCI, NBIX, NDAQ, ODFL, PANW, SCHW, SEZL, TMO, TOL, TRV, UNH, V, VCTR, VRTX, WSM, WST, XPO

**Watchlist (16):** AMG, APD, BIIB, BMY, CPAY, ESE, EXPE, FROG, GEV, LNG, LNT, NET, S, SNOW, TGTX, VCYT


### 3/4 Near-Aligned — 46 names

ADI, ADP, AJG, ALAB, AMAT, AMD, AMZN, ARM, BILL, BRK-B, CRDO, DHR, ETN, EW, FDS, GOOGL, HOOD, IDXX, INTC, IOT, KLAC, KMB, LIN, LRCX, LSCC, MANH, MRVL, MTD, MU, NEE, NVDA, NVO, ONTO, PAYC, PAYX, PG, PRGS, PYPL, RLI, SAIA, SPGI, TLN, TSM, TXN, VRSN, ZM
...
| **SITM** | $554.97 | 2/4 | B | Op Margin -4.2% / Net Margin -6.4% / ROE/ROA ROE -2.6% / ROA -2.3% | SiTime — MEMS precision timing chips; near-monopoly, 65% gross margin,… |
| **SOFI** | $17.28 | 2/4 | A | ROE/ROA ROE 6.6% / ROA 1.3% / FCF Yield missing (no data relief) | SoFi — neobank scaling; ROE 6.6% and trending right |
| **SSNC** | $69.56 | 2/4 | B | Debt/EV 0.318 | SS&C Technologies — fund admin infra, $1.28B FCF, extreme switching co… |
...
| **SLV** | $50.78 | 1/4 | ETF | — | iShares Silver ETF — AUM $37B, silver price proxy; 49% off 6mo highs (… |
| **UPWK** | $9.06 | 1/4 | B | Debt/EV 0.413 | Upwork — freelance marketplace; D/EV 0.44 (converts) only blocker, mar… |
| **AMSC** | $33.03 | 0/4 | A+ | Op Margin 5.1% | American Superconductor — power electronics, grid/defense; OpM 5.1%, o… |
...
|:------:|------:|:---------:|---------:|---------:|------:|------:|:----:|--------:|-------:|:----:|
| **NVDA** | $202.81 | ✗ | +0.3% | -2.7% | $208.53 | $209.68 | IN | -0.94 | +6.0% | — |
| **META** | $646.01 | ✗ | +7.4% | +7.6% | $600.28 | $603.40 | IN | -16.81 | -1.6% | — |
| **MSFT** | $393.82 | ✗ | +3.5% | -2.5% | $403.94 | $401.65 | IN | -11.06 | +1.3% | — |
| **AAPL** | $333.74 | ✓ | +9.9% | +10.6% | $301.84 | $301.64 | +EXT | +8.71 | +7.4% | EXTENDED |
| **AMZN** | $247.23 | ✗ | +2.3% | -2.0% | $252.35 | $252.66 | IN | -6.21 | +5.4% | — |
| **GOOGL** | $346.77 | ✗ | -2.8% | -6.5% | $371.05 | $371.31 | -EXT | -1.67 | +7.8% | — |
| **AVGO** | $370.83 | ✗ | -3.1% | -7.7% | $401.61 | $403.65 | -EXT | -12.32 | +6.7% | — |
| **MU** | $848.95 | ✓ | -17.8% | -8.3% | $925.90 | $929.40 | -EXT | +159.31 | +36.9% | EXTENDED |
| **NFLX** | $68.95 | ✗ | -7.2% | -15.3% | $81.39 | $80.94 | -EXT | -5.70 | -8.2% | — |
