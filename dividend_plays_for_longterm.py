...
UNIVERSE = [
    ...
    'OXY',   # Occidental Petroleum — largest Permian operator (CrownRock acquisition added scale); OxyChem subsidiary (chlorine/caustic soda/PVC) = second revenue leg that partially offsets oil cycle, not purely E&P; Berkshire Hathaway owns ~28%+ common + $10B preferred (8% preferred dividend) and has approval to buy up to 50% — natural buyer floor under any weakness; Vicki Hollub CEO highly regarded; Direct Air Capture (Stratos plant) = carbon optionality + DOE backing; elevated D/EV post-CrownRock but aggressive paydown underway; cut dividend in 2020 so not an aristocrat — sits between CVX/XOM (core) and DVN (satellite); watch debt paydown pace + FCF coverage as the qualifying gate each quarter
