...
UNIVERSE = [
    ...
    'WU',    # Western Union — global money transfer network; 200+ countries, 500K+ agent locations; moat = physical cash-to-cash corridors in underbanked markets (rural Africa, Latin America, Southeast Asia) where Wise/Remitly cannot yet replace the agent walk-in model; ~14% yield (the attraction AND the warning — market pricing dividend risk), payout 75.8%, FCF 9.4% (FCF covers dividend in absolute terms: FCF/EV 9.4% vs dividend cost/EV ~4.3% at D/EV 0.706); OM 13%, NM 9.8%, fwdPE 4.7x; D/EV 0.706 the dominant risk — elevated debt on a business with RevG -1.3% (digital migration eroding physical volume); CAUTION: 14% yield on a declining-revenue business with high debt = classic yield trap setup; the dividend is currently covered but the margin of safety narrows each quarter revenue falls; size small if at all — this is a high-yield value bet, not a compounder; watch RevG and debt paydown quarterly as the gate; added 2026-08-05
