...
def _weekly_swing_html(valid, rs_map, cmf_map, UNIVERSE, WATCHLIST):
    ...
    return (
        ...
        f'near 10w or 20w SMA support. Sorted by closeness to 10wSMA — tightest to support first. NIFTY universe.</div>'
        f'<table><thead><tr>'
...
<details class="guide">
  ...
  <div class="guide-body">
    ...
    <div class="gi"><span class="gi-key">RS vs NIFTY</span><span class="gi-val">13-week return vs NIFTY 50. &gt;1.0x = outperforming India index. 1.15x = 15% stronger than NIFTY.</span></div>
...
if __name__ == '__main__':
    ...
    _cache_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'india_grades_cache.json')
    try:
